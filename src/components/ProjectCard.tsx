...
export function ProjectCard({
  ...
  return (
    <div className="flex flex-col bg-gradient-to-r items-center from-neutral-800 to-neutral-900 max-w-sm rounded-xl overflow-hidden h-[29.5rem] md:h-[520px]">
      ...
      <div className="flex items-center justify-center gap-1 border-t border-zinc-500 w-full transition-opacity py-1 duration-300">
        <a
          href={deploy}
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 bg-transparent flex items-center justify-center rounded-full transition-colors duration-300 cursor-pointer hover:shadow-md hover:shadow-zinc-400"
        >
